...
| Day 15 | 2026-06-19 | Complete | [Day 15.md](Day%2015.md) | [images/Day 15](images/Day%2015/) | 8051 serial port operation, `SBUF`, `SCON`, `TI/RI`, serial modes, baud rate, `PCON/SMOD`, Timer 1/`TH1`, practical `TMOD=20H`/`SCON=50H`/`TR1` Mode 1 setup, transmit/receive polling loops, Intel 8096/MCS-96 overview, 8051 architecture MCQs, SFR/port/reset facts, `MOVC/MOVX`, stack/call/return, arithmetic, logic, rotate, branch, bit-branch, and flag-behavior practice. |
