...
| Day 15 | 2026-06-19 | Complete | [Day 15.md](Day%2015.md) | [images/Day 15](images/Day%2015/) | 8051 serial port operation, full duplex communication, receive buffering, `SBUF` transmit/receive paths, `SCON` bit layout, `REN`, `TI/RI`, `SM0/SM1` serial modes, Mode 0 shift-register operation, Mode 1 UART framing, `TXD/RXD`, baud rate, and Timer 1 baud-rate generation. |
