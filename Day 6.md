...
| --- | --- | --- |
| [till73 p013](images/HandWrittenNotes/till73/page-013.jpg) | <img src="images/HandWrittenNotes/till73/page-013.jpg" width="250"> | Use with `INR M` and binary-result questions. Check whether the result affects `Z`, `S`, `P`, and `AC`. |
| [till73 p014](images/HandWrittenNotes/till73/page-014.jpg) | <img src="images/HandWrittenNotes/till73/page-014.jpg" width="250"> | Use with program trace questions. It shows how to record accumulator, flags, and memory after each instruction. |
| [till73 p015](images/HandWrittenNotes/till73/page-015.jpg) | <img src="images/HandWrittenNotes/till73/page-015.jpg" width="250"> | Use with `CMA`, `INR`, and complement questions. One's complement flips bits; adding one after complement forms two's complement. |
| [till73 p016](images/HandWrittenNotes/till73/page-016.jpg) | <img src="images/HandWrittenNotes/till73/page-016.jpg" width="250"> | Use with stack and program trace questions. Keep `SP`, memory bytes, and register-pair display separate. |
| [till73 p017](images/HandWrittenNotes/till73/page-017.jpg) | <img src="images/HandWrittenNotes/till73/page-017.jpg" width="250"> | Use with rotate questions. Compare `RLC/RRC` circular rotates with `RAL/RAR` rotates through carry. |
| [till73 p018](images/HandWrittenNotes/till73/page-018.jpg) | <img src="images/HandWrittenNotes/till73/page-018.jpg" width="250"> | Use with `XCHG`, `DAD`, `PC`, `SP`, and machine-cycle reasoning. It is a mixed trace sheet. |
| [till73 p019](images/HandWrittenNotes/till73/page-019.jpg) | <img src="images/HandWrittenNotes/till73/page-019.jpg" width="250"> | Use with repeated rotate examples. Write each accumulator state in binary; do not jump straight from hex to answer. |
| [till73 p020](images/HandWrittenNotes/till73/page-020.jpg) | <img src="images/HandWrittenNotes/till73/page-020.jpg" width="250"> | Use with delay-loop calculations. Separate per-iteration T-states from the final exit iteration. |
| [till73 p021](images/HandWrittenNotes/till73/page-021.jpg) | <img src="images/HandWrittenNotes/till73/page-021.jpg" width="250"> | Use with mixed assignment recaps: flags, interrupt meaning, instruction timing, and direct addressing. |
| [till73 p022](images/HandWrittenNotes/till73/page-022.jpg) | <img src="images/HandWrittenNotes/till73/page-022.jpg" width="250"> | Use with memory-block and address-calculation questions. Convert sizes to hex before adding. |
| [till73 p023](images/HandWrittenNotes/till73/page-023.jpg) | <img src="images/HandWrittenNotes/till73/page-023.jpg" width="250"> | Use with `DAD`, `CMP`, `RET`, and interrupt-type questions. It is a final mixed concept page. |
| [till73 p024](images/HandWrittenNotes/till73/page-024.jpg) | <img src="images/HandWrittenNotes/till73/page-024.jpg" width="250"> | Use with `XRA`, `SUI`, `ANA`, and flag tracing. Work in binary for logical instructions and in hex subtraction for `SUI`. |
| [85completed p001](images/HandWrittenNotes/85completed/page-001.jpg) | <img src="images/HandWrittenNotes/85completed/page-001.jpg" width="250"> | Use with loop/register traces and carry/borrow reasoning. It connects arithmetic results to flags. |
| [85completed p002](images/HandWrittenNotes/85completed/page-002.jpg) | <img src="images/HandWrittenNotes/85completed/page-002.jpg" width="250"> | Use with delay-loop screenshots. It shows how repeated loop counts multiply instruction T-states. |
| [85completed p003](images/HandWrittenNotes/85completed/page-003.jpg) | <img src="images/HandWrittenNotes/85completed/page-003.jpg" width="250"> | Use with conditional-output and stack/CALL questions. It ties flags, branch decision, and stack return address together. |
